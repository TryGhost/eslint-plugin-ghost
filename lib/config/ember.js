...
module.exports = {
    ...
    rules: {
        ...
        'ghost/ember/no-restricted-property-modifications': 'off',
        ...
        // Testing
        'ghost/ember/no-current-route-name': 'off',
